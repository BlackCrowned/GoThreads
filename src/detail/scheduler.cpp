...
namespace gothreads {
    namespace detail {
        ...
        scheduler::scheduler(task_pool* ptask_pool, std::mutex* cv_new_task_m, std::mutex* task_pool_m, std::condition_variable* cv_new_task) :
        ...
        void scheduler::run() {
            ...
            while(true) {
                ...
                if (!_task_pool->empty()) {
                    ...
                    task_pool_lk.unlock();
                    std::unique_lock<std::mutex> lk(*_cv_new_task_m, std::defer_lock);
